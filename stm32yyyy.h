...
#define TIM_CCMR1_OC1MD(x)	(((x) & 8u) << 13 | (x & 7) << TIM_CCMR1_OC1M_Pos)
#define TIM_CCMR1_OC2MD(x)	(TIM_CCMR1_OC1MD(x) << 8)

#define TIM_CCMR1_OC1M_PWM1	TIM_CCMR1_OC1MD(6)	// OC1M[2:0] - PWM mode 1
#define TIM_CCMR1_OC2M_PWM1	TIM_CCMR1_OC2MD(6)	// OC1M[2:0] - PWM mode 1
#define TIM_CCMR2_OC3M_PWM1	TIM_CCMR1_OC1M_PWM1	// OC3M[2:0] - PWM mode 1
#define TIM_CCMR2_OC4M_PWM1	TIM_CCMR1_OC2M_PWM1	// OC4M[2:0] - PWM mode 1

#define TIM_CCMR1_OC1M_PWM2	TIM_CCMR1_OC1MD(7)	// OC1M[2:0] - PWM mode 1
#define TIM_CCMR1_OC2M_PWM2	TIM_CCMR1_OC2MD(7)	// OC1M[2:0] - PWM mode 1
#define TIM_CCMR2_OC3M_PWM2	TIM_CCMR1_OC1M_PWM2	// OC3M[2:0] - PWM mode 1
#define TIM_CCMR2_OC4M_PWM2	TIM_CCMR1_OC2M_PWM2	// OC4M[2:0] - PWM mode 1

#define TIM_CCMR1_OC1M_ROPM1	TIM_CCMR1_OC1MD(8)	// OC1M[3:0] - Retrig OPM mode 1
#define TIM_CCMR1_OC2M_ROPM1	TIM_CCMR1_OC2MD(8)	// OC1M[3:0] - Retrig OPM mode 1
#define TIM_CCMR2_OC3M_ROPM1	TIM_CCMR1_OC1M_ROPM1	// OC1M[3:0] - Retrig OPM mode 1
#define TIM_CCMR2_OC4M_ROPM1	TIM_CCMR1_OC2M_ROPM1	// OC1M[3:0] - Retrig OPM mode 1

#define TIM_CCMR1_OC1M_ROPM2	TIM_CCMR1_OC1MD(9)	// OC1M[3:0] - Retrig OPM mode 2
#define TIM_CCMR1_OC2M_ROPM2	TIM_CCMR1_OC2MD(9)	// OC1M[3:0] - Retrig OPM mode 2
#define TIM_CCMR2_OC3M_ROPM2	TIM_CCMR1_OC1M_ROPM2	// OC1M[3:0] - Retrig OPM mode 1
#define TIM_CCMR2_OC4M_ROPM2	TIM_CCMR1_OC2M_ROPM2	// OC1M[3:0] - Retrig OPM mode 1

#define TIM_CCMR1_OC1M_CPWM1	TIM_CCMR1_OC1MD(12)	// OC1M[3:0] - Combined PWM mode 1 (OR)
#define TIM_CCMR1_OC2M_CPWM1	TIM_CCMR1_OC2MD(12)	// OC1M[3:0] - Combined PWM mode 1 (OR)
#define TIM_CCMR2_OC3M_CPWM1	TIM_CCMR1_OC1M_CPWM1	// OC1M[3:0] - Combined PWM mode 1
#define TIM_CCMR2_OC4M_CPWM1	TIM_CCMR1_OC2M_CPWM1	// OC1M[3:0] - Combined PWM mode 1

#define TIM_CCMR1_OC1M_CPWM2	TIM_CCMR1_OC1MD(13)	// OC1M[3:0] - Combined PWM mode 2 (AND)
#define TIM_CCMR1_OC2M_CPWM2	TIM_CCMR1_OC2MD(13)	// OC1M[3:0] - Combined PWM mode 2 (AND)
#define TIM_CCMR2_OC3M_CPWM2	TIM_CCMR1_OC1M_CPWM2	// OC1M[3:0] - Combined PWM mode 2
#define TIM_CCMR2_OC4M_CPWM2	TIM_CCMR1_OC2M_CPWM2	// OC1M[3:0] - Combined PWM mode 2

#define	TIM_CCMR1_OC12PE	(TIM_CCMR1_OC1PE | TIM_CCMR1_OC2PE)
#define	TIM_CCMR2_OC34PE	(TIM_CCMR2_OC3PE | TIM_CCMR2_OC4PE)
#define	TIM_CCMR_OCPE	(TIM_CCMR1_OC1PE | TIM_CCMR1_OC2PE)	// same for both CCMR
